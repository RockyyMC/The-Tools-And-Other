...
public class DuckEntity extends TamableAnimal {
	...
	public AgeableMob getBreedOffspring(ServerLevel serverWorld, AgeableMob ageable) {
		DuckEntity retval = TheToolsAndOtherModEntities.DUCK.get().create(serverWorld, EntitySpawnReason.BREEDING);
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(Items.WHEAT_SEEDS, Items.PUMPKIN_SEEDS, Items.TORCHFLOWER_SEEDS, Items.MELON_SEEDS, Items.BEETROOT_SEEDS).test(stack);
	}

	public static void init(RegisterSpawnPlacementsEvent event) {
		event.register(TheToolsAndOtherModEntities.DUCK.get(), SpawnPlacementTypes.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
