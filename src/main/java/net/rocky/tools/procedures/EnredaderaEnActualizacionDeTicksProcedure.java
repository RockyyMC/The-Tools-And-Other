...
public class EnredaderaEnActualizacionDeTicksProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		...
		if ((world.getBlockState(BlockPos.containing(x, y + 1, z))).getBlock() == TheToolsAndOtherModBlocks.ENREDADERA.get() || (world.getBlockState(BlockPos.containing(x, y - 1, z))).getBlock() == TheToolsAndOtherModBlocks.ENREDADERA.get()) {
			if (Math.random() < 0.02) {
				{
