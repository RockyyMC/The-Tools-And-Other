...
public class Modelmatistv2 extends EntityModel<LivingEntityRenderState> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath("the_tools_and_other", "modelmatistv_2"), "main");
