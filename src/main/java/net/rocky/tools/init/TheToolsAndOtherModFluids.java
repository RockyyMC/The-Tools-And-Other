...
import net.rocky.tools.fluid.YellowWaterFluid;
import net.rocky.tools.fluid.WaterFluid;
import net.rocky.tools.fluid.ToxicFluid;
import net.rocky.tools.fluid.RedWaterFluid;
import net.rocky.tools.fluid.PurpleWaterFluid;
import net.rocky.tools.fluid.PinkWaterFluid;
import net.rocky.tools.fluid.PetrolleoFluid;
import net.rocky.tools.fluid.OrangeWaterFluid;
import net.rocky.tools.fluid.MilkFluid;
import net.rocky.tools.fluid.LightBlueWaterFluid;
import net.rocky.tools.fluid.GreenWaterFluid;
import net.rocky.tools.fluid.CursedFluid;
import net.rocky.tools.fluid.BrownWaterFluid;
import net.rocky.tools.fluid.BlueWaterFluid;
import net.rocky.tools.fluid.ArcoirisWaterFluid;
import net.rocky.tools.fluid.AquaWaterFluid;
...
public class TheToolsAndOtherModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(BuiltInRegistries.FLUID, TheToolsAndOtherMod.MODID);
