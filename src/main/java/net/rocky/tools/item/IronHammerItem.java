...
public class IronHammerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 4095, 11f, 0, 12, TagKey.create(Registries.ITEM, ResourceLocation.parse("the_tools_and_other:iron_hammer_repair_items")));

	public IronHammerItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 18f, -2f)
