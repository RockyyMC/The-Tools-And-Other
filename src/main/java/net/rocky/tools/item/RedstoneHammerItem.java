...
public class RedstoneHammerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_IRON_TOOL, 4700, 12f, 0, 9, TagKey.create(Registries.ITEM, ResourceLocation.parse("the_tools_and_other:redstone_hammer_repair_items")));
