...
public class DiamondHammerItem extends Item {
	private static final ToolMaterial TOOL_MATERIAL = new ToolMaterial(BlockTags.INCORRECT_FOR_DIAMOND_TOOL, 6700, 12f, 0, 7, TagKey.create(Registries.ITEM, ResourceLocation.parse("the_tools_and_other:diamond_hammer_repair_items")));

	public DiamondHammerItem(Item.Properties properties) {
		super(TOOL_MATERIAL.applyToolProperties(properties, BlockTags.MINEABLE_WITH_PICKAXE, 18f, -1f)
