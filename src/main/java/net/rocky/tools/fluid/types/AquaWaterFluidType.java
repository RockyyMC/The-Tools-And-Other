...
public class AquaWaterFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/aqua_water_f");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/aqua_water_s");
		...
		}, TheToolsAndOtherModFluidTypes.AQUA_WATER_TYPE.get());
	}
}
