...
public class MilkFluidType extends FluidType {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/milk");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/milk");
		...
		}, TheToolsAndOtherModFluidTypes.MILK_TYPE.get());
	}
}
