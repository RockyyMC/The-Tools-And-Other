...
public class BlueWaterFluidType extends FluidType {
	public BlueWaterFluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/blue_water_flow");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/blue_water_still");
		...
		}, TheToolsAndOtherModFluidTypes.BLUE_WATER_TYPE.get());
	}
}
