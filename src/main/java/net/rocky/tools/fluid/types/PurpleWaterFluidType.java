...
public class PurpleWaterFluidType extends FluidType {
	public PurpleWaterFluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/purple_water_still");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/purple_water_flow");
			...
			public Vector4f modifyFogColor(Camera camera, float partialTick, ClientLevel level, int renderDistance, float darkenWorldAmount, Vector4f fluidFogColor) {
				return new Vector4f(0.6f, 0f, 0.6f, fluidFogColor.w);
			}
		...
		}, TheToolsAndOtherModFluidTypes.PURPLE_WATER_TYPE.get());
	}
}
