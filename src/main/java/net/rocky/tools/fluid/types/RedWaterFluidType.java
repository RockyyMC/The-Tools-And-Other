...
public class RedWaterFluidType extends FluidType {
	public RedWaterFluidType() {
	...
	public static void registerFluidTypeExtensions(RegisterClientExtensionsEvent event) {
		event.registerFluidType(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/red_water");
			private static final ResourceLocation FLOWING_TEXTURE = ResourceLocation.parse("the_tools_and_other:block/red_water");
		...
		}, TheToolsAndOtherModFluidTypes.RED_WATER_TYPE.get());
	}
}
